(() => {
  ...
  const hans = {
    ...
    betaH:'一起打磨青苔',betaB:'申请内测；版本准备好后，我们会寄信通知你。',email:'你的邮箱',request:'申请内测',footer:'页脚',privacy:'隐私',github:'在 GitHub 查看青苔',language:'语言',
  ...
  const hant = {
    ...
    betaH:'一起打磨青苔',betaB:'申請封閉測試；版本準備好後，我們會寄信通知你。',email:'你的電子郵件',request:'申請封閉測試',footer:'頁尾',privacy:'隱私權',github:'在 GitHub 查看青苔',language:'語言',
