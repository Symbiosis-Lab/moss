(() => {
  ...
  function apply(next){
    ...
    const select=document.querySelector('#language-select');if(select){select.value=next;select.setAttribute('aria-label',c.language)}text('.language-picker .sr-only','language');
