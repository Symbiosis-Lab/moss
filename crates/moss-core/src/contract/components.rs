...
pub const COMPONENTS: &[ComponentEntry] = &[
  ...
  <div class="moss-card-minimal">...</div>
    ...
    ComponentEntry {
        ...
        data_attrs: &[
            ...
            DataAttr {
                ...
                values: &[],
                default: "",
                description: "Presence flag: emitted IFF the card was built from a `:::grid` cell whose link leaves the site — the owner's \"one card kind\" decision (2026-09), replacing the differently-shaped `.moss-grid-card.link-preview` shell (see that entry, now `Retired`). Always paired with `target=\"_blank\" rel=\"noopener\"`. The card's kicker shows the domain (with `.moss-card-kicker-favicon` when one is cached); its cover is the author's own image when the cell carried one, else the plain no-cover placeholder — a fetched title never displaces authored content.",
            },
        ],
    ...
    ComponentEntry {
        class: "moss-card-kicker-favicon",
        kind: "instance",
        parent: "moss-card-kicker",
        data_attrs: &[],
        example_html: r#"<img class="moss-card-kicker-favicon" src="..." width="16" height="16" alt="" />"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "1",
        description: "Favicon inline before the domain, on a `[data-external]` card's kicker — emitted only when one is cached for the link. Same `ImageContext::Favicon` synthesis the retired `.link-preview-favicon` used (bare `<img>`, no manifest, no `<picture>`, no LQIP).",
    },
    ComponentEntry {
  ...
  <div class="moss-hero-content">...</div>
    ...
    ComponentEntry {
        ...
        parent: "",
        data_attrs: &[],
        example_html: r#"<p class="moss-hero-caption">封面：山城舊教堂門口的無名將士紀念牆（拍攝：陳遠山）</p>"#,
...
",
  ...
  <div class="moss-grid-card">...</div>
    ...
    ComponentEntry {
        ...
        status: Status::Retired,
        since: "0",
        description: "Retired 2026-09 — an external grid-cell link now renders as `.moss-card` (see that entry's `data-external`), the same card kind an internal page uses, instead of this differently-shaped title+favicon/domain row.",
    },
    ComponentEntry {
        ...
        status: Status::Retired,
        since: "0",
        description: "Retired 2026-09 alongside `link-preview` — collapsed into `.moss-card-title`.",
    },
    ComponentEntry {
        ...
        status: Status::Retired,
        since: "0",
        description: "Retired 2026-09 alongside `link-preview` — the domain now lives in `.moss-card-kicker`, alongside `.moss-card-kicker-favicon` when one is cached.",
    },
    ComponentEntry {
        class: "moss-gallery",
        kind: "container",
  ...
  <a href="https://mosspub.com" aria-label="Published with moss">
    ...
    ComponentEntry {
        ...
        parent: "",
        data_attrs: &[],
        example_html: r#"<div class="moss-byline"><div class="moss-byline-row">作者　陳遠山</div><div class="moss-byline-row">編輯　周一</div></div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "1",
    ...
    ComponentEntry {
        ...
        parent: "moss-byline",
        data_attrs: &[],
        example_html: r#"<div class="moss-byline-row">首發媒體　<a href="https://example.org/a">遠聲媒體</a></div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "1",
    ...
    ComponentEntry {
        ...
        parent: "",
        data_attrs: &[],
        example_html: r#"<div class="moss-article-colophon"><div class="moss-article-colophon-row">首發媒體　<a href="https://example.org/a">遠聲媒體</a></div></div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "1",
    ...
    ComponentEntry {
        ...
        data_attrs: &[],
        example_html: r#"<div class="moss-article-colophon-row">封面　山城舊教堂門口的無名將士紀念牆（拍攝：陳遠山）</div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "1",
    ...
    ComponentEntry {
        ...
        parent: "main-nav",
        data_attrs: &[],
        example_html: r#"<a href="/" class="site-name">河灣</a>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
    ...
    ComponentEntry {
        ...
        parent: "main-nav",
        data_attrs: &[],
        example_html: r#"<a href="/awards/" class="breadcrumb-segment">評選</a>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
    ...
    ComponentEntry {
        ...
        parent: "main-nav",
        data_attrs: &[],
        example_html: r#"<div class="nav-left"><a href="/" class="site-name">河灣</a></div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
    ...
    ComponentEntry {
        ...
        parent: "nav-left",
        data_attrs: &[],
        example_html: r#"<span class="breadcrumb-label">評選</span>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
...
<li id="fn-1" tabindex="-1"><p>The note. <a class="moss-footnote-backref" href="#fnref-1" role="doc-backlink" aria-label="Back to reference 1">&#8617;&#xFE0E;</a></p>
    ...
    ComponentEntry {
        ...
        parent: "",
        data_attrs: &[],
        example_html: r#"<ul class="moss-place-children"><li><a href="/places/kyoto/">Kyoto (3)</a></li></ul>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Direct child places on a place page, each with its roll-up-inclusive member count. Absent for a leaf place with no children, and for every non-place term.",
    },
    ComponentEntry {
        class: "moss-place-line",
        kind: "instance",
        parent: "",
        data_attrs: &[],
        example_html: r#"<div class="moss-place-line">Location: <a href="/places/kyoto/">Kyoto</a></div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "The automatic place line under a page's byline, generated from `location:` — every declared place, linked to its term page. Absent when `location:` is unset, or the site declares no place-typed kind. No opt-out: this is generated chrome with no authored equivalent.",
    },
    ComponentEntry {
        class: "moss-place-map",
        kind: "instance",
        parent: "",
        data_attrs: &[],
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Offline SVG map on a place term page or explicit `style:map` embed. Geography and privacy precision come from `.moss/places.toml`; no browser network request is made.",
    },
    ComponentEntry {
        class: "moss-place-map-frame",
        kind: "container",
        parent: "",
        data_attrs: &[],
        example_html: r#"<div class="moss-place-map-frame"><figure class="moss-place-map"></figure></div>"#,
        example_markdown: r#"![[/places/kyoto/|style:map|wide]]"#,
        status: Status::Confirmed,
        since: "0",
        description: "Placement wrapper for an explicit map embed. Carries the standard width, alignment and size attributes while the semantic map figure remains self-contained.",
    },
    ComponentEntry {
        class: "moss-place-map-caption",
        kind: "instance",
        parent: "moss-place-map-frame",
        data_attrs: &[],
        example_html: r#"<div class="moss-place-map-caption">Kyoto</div>"#,
        example_markdown: r#"![[/places/kyoto/|style:map|Kyoto]]"#,
        status: Status::Confirmed,
        since: "0",
        description: "Optional caption below an explicitly embedded place map.",
    },
    ComponentEntry {
        class: "moss-place-locator",
        kind: "container",
        parent: "",
        data_attrs: &[],
        example_html: r#"<div class="moss-place-locator moss-align-right"><figure class="moss-place-map"></figure></div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Compact sparse map after an authored page's location line when `[site].locator = \"align-right\"`; collapses into the reading flow on narrow screens.",
    },
];
