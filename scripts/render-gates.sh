...
# ---------------------------------------------------------------------------
# Argument parsing: --group build|nobuild, --list, --check, plus the
# pre-existing positional gate-name form, which still overrides everything
# else exactly as it did before this split.
GROUP=""
DO_LIST=false
DO_CHECK=false
POSITIONAL=()
